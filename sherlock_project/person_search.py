...
class PersonOSINT:
    ...
    def search_person(self, first_name: str, last_name: str, extra_info: str = "", stop_event=None, progress_callback=None) -> Dict[str, List[Dict[str, str]]]:
        ...
        dorks = {
            ...
            "Sport & Hobby's": f"(site:strava.com/athletes OR site:runkeeper.com OR site:chess.com/member OR site:lichess.org/@ OR site:komoot.com OR site:alltrails.com) {escaped_name}{extra_query}",
            ...
            "Blogs & Publicaties": f"(site:wordpress.com OR site:blogspot.com OR site:tumblr.com OR site:substack.com OR site:ghost.io) {escaped_name}{extra_query}",
            "Fotografie & Media": f"(site:flickr.com OR site:vimeo.com OR site:soundcloud.com OR site:deviantart.com OR site:behance.net OR site:500px.com OR site:unsplash.com) {escaped_name}{extra_query}"
        }
