...
class PhoneOSINT:
    ...
    def search_phone_advanced_dorks(self, meta: Dict[str, Any], stop_event=None, progress_callback=None) -> Dict[str, List[Dict[str, str]]]:
        ...
        dorks = {
            "Lek- & Paste-sites": f"(site:pastebin.com OR site:paste.org OR site:github.com OR site:gitlab.com OR site:gitter.im OR site:paste2.org OR site:ghostbin.co OR site:controlc.com OR site:pastelink.net OR site:rentry.co OR site:justpaste.it OR site:cracked.io OR site:leak-lookup.com) ({terms_or})",
            ...
            "Professionele Netwerken": f"(site:linkedin.com/in OR site:linkedin.com/pub OR site:xing.com OR site:rocketreach.co OR site:apollo.io OR site:zoominfo.com OR site:lusha.com OR site:signalhire.com OR site:contactout.com OR site:crunchbase.com) ({terms_or})",
    ...
    def search_username_advanced_dorks(self, username: str, stop_event=None, progress_callback=None) -> Dict[str, List[Dict[str, str]]]:
        ...
        dorks = {
            "Lek- & Paste-sites": f"(site:pastebin.com OR site:paste.org OR site:github.com OR site:gitlab.com OR site:gitter.im OR site:paste2.org OR site:ghostbin.co OR site:controlc.com OR site:pastelink.net OR site:rentry.co OR site:justpaste.it OR site:cracked.io OR site:leak-lookup.com) {escaped_username}",
            ...
            "Professionele Netwerken": f"(site:linkedin.com/in OR site:linkedin.com/pub OR site:xing.com OR site:rocketreach.co OR site:apollo.io OR site:zoominfo.com OR site:lusha.com OR site:signalhire.com OR site:contactout.com OR site:crunchbase.com) {escaped_username}",
            ...
            "Gaming & Entertainment": f"(site:steamcommunity.com OR site:twitch.tv OR site:xbox.com OR site:playstation.com OR site:ign.com OR site:roblox.com OR site:epicgames.com) {escaped_username}",
